    ...
    <div class="wrapper">
      ...
      <form class="form" action="/customer" method="post">
        <div class="input_field">
          ...
          <input type="text" name="name" class="input" value="${customer.customerName}" >
        </div>
        <div class="input_field">
          <label>Birthday</label>
          <input type="date" name="birthday" class="input"  value="${customer.customerBirthday}" >
        </div>
        <div class="input_field">
          <label>Gender</label>
        ...
        <div class="input_field">
          <label>Card ID</label>
          <input type="text" name="cardID" class="input" value="${customer.customerIDCard}" >
        </div>
        <div class="input_field">
          <label>User Phone</label>
          <input type="text" name="phone" class="input" value="${customer.customerPhone}" >
        </div>
        <div class="input_field">
          <label>User Email</label>
          <input type="text" name="email" class="input" value="${customer.customerEmail}" >
        </div>
        <div class="input_field">
          <label>User Address</label>
          <input type="text" name="address" class="input" value="${customer.customerAddress}" >
        </div>
        <div class="input_field">
